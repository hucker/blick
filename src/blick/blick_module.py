"""
BlickModule represents a module with a functions set that can be run. A module
...
class BlickModule:
    ...
    def __init__(
        ...
        self.check_functions: list[BlickFunction] = []
    ...
    def __str__(self):
        return (
            f"BlickModule({self.module_name=},{self.check_function_count=} functions)"
        )
    ...
    def add_check_function(self, module, function):
        """Wrap the function in a blick function"""
        function = BlickFunction(function, module)
    ...
    def load(self, module_name=None):
        ...
        try:
            ...
            raise BlickException(f"Can't load {module_name}:{iex.msg}") from iex
