...
def main():
    """
    Main method for running the Blick package checker.

    Usage:
        Run this method to run the Blick package checker. It prompts the user to select options for including or
        excluding functions based on tags, rule IDs, levels, and phases. After selecting the options,
        click the "Run Blick" button to start the rule checking process. The results will be displayed in the UI.
