...
from blick import BlickException, blick_rc_factory
...
def test_factory():
    ...
    rc1 = blick_rc_factory(param='./rc_files/good.json', section='package1')
    rc2 = blick_rc_factory(param='./rc_files/good.toml', section='package1')
    rc3 = blick_rc_factory(param=rc_dict, section='package1')
    rc4 = blick_rc_factory(param=rc_dict['package1'])
    rc5 = blick_rc_factory(param='./rc_files/good.xml', section='package1')
    rc6 = blick_rc_factory(param='./rc_files/good.ini', section='package1')
...
def test_factory_exception(param):
    with pytest.raises(BlickException):
        _ = blick_rc_factory(param=param, section='')
...
def test_more_exceptions(param, section):
    with pytest.raises(BlickException):
        _ = blick_rc_factory(param, section=section)
