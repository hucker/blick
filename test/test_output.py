...
@pytest.fixture
def simple1():
    @blick.attributes(tag="t1", level=1, ruid="ruid_1", phase='proto')
    def func1():
        """my doc string"""
...
@pytest.fixture
def simple2():
    @blick.attributes(tag="t2", level=2, ruid="ruid_2", phase='production')
    def func2():
        """my doc string"""
...
def test_json(simple1, simple2):
    ...
    ch = blick.BlickChecker(check_functions=[simple1, simple2], auto_setup=True)
    _ = ch.run_all()
    d = ch.as_dict()
