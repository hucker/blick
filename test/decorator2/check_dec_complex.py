...
@blick.attributes(tag='tag2', level=2)
def check_dec21():
    """DocString for check_dec1"""
    yield blick.BlickResult(status=True, msg="Result check_dec2")


@blick.attributes(tag='tag3', level=2)
def check_dec22():
    """DocString for check_dec1"""
    yield blick.BlickResult(status=True, msg="Result check_dec4")


@blick.attributes(tag='tag4', level=3)
def check_dec31():
    """DocString for check_dec1"""
    yield blick.BlickResult(status=True, msg="Result check_dec31")


@blick.attributes(tag='tag5', level=3)
def check_dec32():
    """DocString for check_dec22"""
    yield blick.BlickResult(status=True, msg="Result check_dec32")


@blick.attributes(tag='tag6', level=3)
def check_dec33():
    """DocString for check_dec22"""
    yield blick.BlickResult(status=True, msg="Result check_dec33")
